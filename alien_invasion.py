...
def run_game():
    ...
    while True:
        gf.check_events(ai_settings, screen, ship, bullets, play_button, game_stats, aliens)
        ...
        gf.update_screen(ai_settings, screen, ship, bullets,aliens, play_button, game_stats)
